 ...
 */
public class AStarSchedulingAlgorithmOld extends Algorithm {
	...
	public AStarSchedulingAlgorithmOld(ChildScheduleFinderOld childGenerator, MinimumHeuristic heuristic, RuntimeMonitor monitor, ScheduleStorage storage) {
		super(monitor);
	...
	public AStarSchedulingAlgorithmOld(ChildScheduleFinderOld childGenerator, MinimumHeuristic heuristic, RuntimeMonitor monitor) {
		super(monitor);
	...
	public AStarSchedulingAlgorithmOld(ChildScheduleFinderOld childGenerator, MinimumHeuristic heuristic) {
		super();
